...
sim = 2 # sim = 0 is closest exit, sim = 1 is assigned exit, sim = 2 is closest with some dizzy particles, sim=3 is assigned with some dizzy agents.
...
try:
    ani.save('particle_simulation.gif', writer=PillowWriter(fps=20))
